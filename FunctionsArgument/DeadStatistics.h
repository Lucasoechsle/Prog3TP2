//
// Created by lucasoechsle on 5/11/21.
//


#ifndef TRABAJOFINAL_DEADSTATISTICS_H
#define TRABAJOFINAL_DEADSTATISTICS_H


void DeadStatistics(string path) {
...
#endif //TRABAJOFINAL_DEADSTATISTICS_H
